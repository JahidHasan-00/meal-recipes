    ...
    return (
        <div className='flex justify-center w-2/5 mx-auto m-4 px-3 py-2 border-2 rounded-lg border-blue-100'>
            <div className="card w-[465px] bg-blue-100 ">
                <figure><img className='w-11/12 rounded-lg' src={strMealThumb} alt="recipe_image"/></figure>
                <div className="card-body space-y-4">
                    ...
                    <p className='text-sm'><span className='text-base font-medium border-b-2 border-dotted border-black'>Source</span>: <br />{meal?.strSource}</p>
                    <div>
