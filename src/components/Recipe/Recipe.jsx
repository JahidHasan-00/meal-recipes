...
const Recipe = ({recipe}) => {
    ...
    return (
        <div className='m-2 p-3 border-2 rounded-lg border-yellow-400'>
            <div className="card bg-blue-100 h-[550px]">
                    ...
                    <div className="card-body px-0 items-center">
                        ...
                        <div className="card-actions flex-col items-center">
                            <Link to={`/recipes/${idMeal}`}><button className="btn btn-primary">Show Details</button></Link>
                            <button onClick={} className='btn btn-primary'>Click to show details</button>
                        </div>
                    </div>
            </div>
        </div>
